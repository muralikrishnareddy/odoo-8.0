...
class account_voucher_line(osv.osv):
    ...
    def create(self, cr, uid, vals, context=None):
        print 'pppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppp',vals
        retvals = super(account_voucher_line, self).create(cr, uid, vals, context=context)
        return retvals
